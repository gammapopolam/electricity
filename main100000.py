...
#print(gdf_exploded)
exporter(gdf_exploded.copy(), name='coursework/100000/exploded.gpkg', keep_debug=True, epsg=epsg)
...
#print(gdf_buffer)
exporter(gdf_buffer.copy(), name='coursework/100000/clipped.gpkg', keep_debug=True, buffer=False, epsg=epsg)
exporter(gdf_buffer.copy(), name='coursework/100000/buffer.gpkg', keep_debug=True, buffer=True, epsg=epsg)
#%%
...
exporter(gdf_processed.copy(), name='coursework/100000/processed.gpkg', keep_debug=True, buffer=False, epsg=epsg)
#%%
...
exporter(gdf_flipped.copy(), name='coursework/100000/flipped.gpkg', keep_debug=True, epsg=epsg)
# Параллельный сдвиг
start_time = time.time()
...
exporter(gdf_unpacked.copy(), name='coursework/100000/offsetted.gpkg', keep_debug=True, epsg=epsg)
#%%
gdf_unpacked_2=unpack_multilines(gdf_offset)
# Восстановление направления сегментов нити
start_time = time.time()
gdf_origin_2=gpd.read_file('coursework/100000/exploded.gpkg')
...
exporter(gdf_recover.copy(), name='coursework/100000/line_recovered.gpkg', keep_debug=True, epsg=32635)
#%%
# Восстановление сети
start_time = time.time()
gdf_net=recover_net(gdf_recover, 'coursework/50000/logs.txt')
print("Recovering finished --- %s seconds ---" % (time.time() - start_time))
exporter(gdf_net.copy(), name='coursework/100000/final.gpkg', keep_debug=True, epsg=32635)
